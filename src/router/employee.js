...
router.get("/viewleavesrequest",auth, sessions, leavesController.viewleaves);
...
router.get('/timeEntryListing',auth, sessions, NewTimeEntryController.timeEntrieslisting);
