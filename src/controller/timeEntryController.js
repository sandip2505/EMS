...
timeEntryController.getTimeEntries = async (req, res) => {
 ...
 var projects_id=[]
  ...
  res.render("AddtimeEntry", { data:tasks,loggeduserdata: req.user, timeEntryData:timeEntryData,Permission : "View Holiday",});
  // return res.status(200).json({ tasks });
}else{
  res.render("AddtimeEntry", { data:[],loggeduserdata: req.user, Permission : "View Holiday",});
}
}
