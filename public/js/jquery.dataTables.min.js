...
// Initialize the DataTable with the current page number
$(document).ready(function () {
  var table = $("#myTable").DataTable();
  table.page(currentPage).draw("page");

  // Save the current page number when edit button is clicked
  $("#myTable tbody").on("click", ".edit-btn", function () {
    currentPage = table.page();
  });
});

// Restore the current page number when the user navigates back to the page
